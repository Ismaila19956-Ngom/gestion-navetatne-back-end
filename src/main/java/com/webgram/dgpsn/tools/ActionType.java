package com.webgram.dgpsn.tools;
...
public class ActionType {
     ...
     // Workflow Historique
     public final String READ_WORKFLOW_HISTORIQUE = "Consultation de l'historique de validation : SÉCURITÉ / Workflow";
     public final String ADD_WORKFLOW_HISTORIQUE = "Ajout à l'historique de validation : SÉCURITÉ / Workflow / Ajouter";
     public final String EDIT_WORKFLOW_HISTORIQUE = "Modification de l'historique de validation : SÉCURITÉ / Workflow / Modifier";
     public final String DELETE_WORKFLOW_HISTORIQUE = "Suppression de l'historique de validation : SÉCURITÉ / Workflow / Supprimer";
