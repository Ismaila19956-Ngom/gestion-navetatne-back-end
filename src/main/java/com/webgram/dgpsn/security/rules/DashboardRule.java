...
public class DashboardRule {
  ...
  static final String GEO_PROJECT_ID = "/projects-by-geo";
    ...
    static final String SERVICE_EXTERIEUR_ACTIVITIES_BY_STATUS = "/service-exterieur/activities-by-status";
    static final String SERVICE_EXTERIEUR_TOP5_BY_BUDGET = "/service-exterieur/top5-by-budget";
    ...
    public SecurityRule getServiceExterieurKpis() {
        return SecurityRule.builder()
                ...
                .hasPermission(SecurityPermissions.READ_TDB_SERVICE_EXTERIEUR)
    ...
    public SecurityRule getServiceExterieurActivitiesByStatus() {
        return SecurityRule.builder()
                .httpMethod(HttpMethod.GET)
                .apiPattern(DASHBOARD_API_PREFIX + SERVICE_EXTERIEUR_ACTIVITIES_BY_STATUS)
                .build()
                .condition()
                .hasPermission(SecurityPermissions.READ_TDB_RESUME)
                .hasPermission(SecurityPermissions.READ_TDB_SERVICE_EXTERIEUR)
    ...
    public SecurityRule getServiceExterieurTop5ByBudget() {
        return SecurityRule.builder()
                .httpMethod(HttpMethod.GET)
                .apiPattern(DASHBOARD_API_PREFIX + SERVICE_EXTERIEUR_TOP5_BY_BUDGET)
                .build()
                .condition()
                .hasPermission(SecurityPermissions.READ_TDB_RESUME)
                .hasPermission(SecurityPermissions.READ_TDB_SERVICE_EXTERIEUR)
