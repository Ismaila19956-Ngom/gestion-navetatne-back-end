...
public class GlobalControllerExceptionHandler {
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    @ExceptionHandler(BudgetDepassementException.class)
    public Error budgetDepassement(BudgetDepassementException e) {

        logger.error("Budget dépassé: {}", e.getMessage());
    ...
    public Error illegalArgument(IllegalArgumentException e) {
