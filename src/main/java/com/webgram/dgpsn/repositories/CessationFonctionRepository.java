...
import com.webgram.dgpsn.models.responses.DureeRangeDTO;
...
//     List<StaticCessationDTO> findCurrentCessations();
    ...
    // src/main/java/com/webgram/dgpsn/repositories/CessationFonctionRepository.java
    @Query("""
       SELECT new com.webgram.dgpsn.models.responses.DureeRangeDTO(
           CASE
             WHEN cf.nombreDeJoursdemande BETWEEN 1 AND 5   THEN '1-5 jours'
             WHEN cf.nombreDeJoursdemande BETWEEN 6 AND 10  THEN '6-10 jours'
             WHEN cf.nombreDeJoursdemande BETWEEN 11 AND 15 THEN '11-15 jours'
             WHEN cf.nombreDeJoursdemande BETWEEN 16 AND 20 THEN '16-20 jours'
             ELSE '21+ jours'
           END,
           COUNT(cf)
       )
       ...
       ORDER BY 
           MIN(
               CASE
                 WHEN cf.nombreDeJoursdemande BETWEEN 1 AND 5   THEN 1
                 WHEN cf.nombreDeJoursdemande BETWEEN 6 AND 10  THEN 2
                 WHEN cf.nombreDeJoursdemande BETWEEN 11 AND 15 THEN 3
                 WHEN cf.nombreDeJoursdemande BETWEEN 16 AND 20 THEN 4
                 ELSE 5
               END
           )
       """)
    List<DureeRangeDTO> countCessationDureeRange();
