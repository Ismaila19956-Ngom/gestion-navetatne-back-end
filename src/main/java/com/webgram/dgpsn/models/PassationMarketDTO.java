...
public class PassationMarketDTO implements Serializable {
    ...
    @JsonProperty(access = JsonProperty.Access.READ_ONLY)
    private LabelDTO typeMarket;

    @Schema(accessMode = Schema.AccessMode.READ_ONLY)
    @JsonProperty(access = JsonProperty.Access.READ_ONLY)
    private LabelDTO typePassation;

    @Schema(accessMode = Schema.AccessMode.READ_ONLY)
    @JsonProperty(access = JsonProperty.Access.READ_ONLY)
    private LabelDTO cible;

    @Schema(accessMode = Schema.AccessMode.READ_ONLY)
    @JsonProperty(access = JsonProperty.Access.READ_ONLY)
    private PassationPlanDTO passationPlanEntity;

    private Long passationPlanId;

    private Long typeMarketId;

    private Long typePassationId;
