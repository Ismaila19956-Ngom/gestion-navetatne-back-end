...
public class Response<T> {
    ...
    private Object inconsistencies; // Nouveau champ pour les incohérences
    ...
    public enum Status {
        ...
        FIRST_CONNECTION, DISABLED_ACCOUNT, INVALIDE_TOKEN, INVALIDE_URL, UNSUPPORTED_MEDIA_TYPE, DIRECTORY_NOT_FOUND, CREATED, WARNING, ERROR, DELETED
    }
